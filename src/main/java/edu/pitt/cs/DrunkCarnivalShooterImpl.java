...
public class DrunkCarnivalShooterImpl implements DrunkCarnivalShooter {
    ...
    //    since we assign them in constructor, they should be instance instead of static
    private Random rand;
    ...
    DrunkCarnivalShooterImpl() {
        ...
        //        constructor should give variables a defined value instead of null
     ...
     * the original target number (stale comment that needs removal)
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 1 && args[0].equals("test")) {
            ...
            //            recommend encoding style is UTF-8
